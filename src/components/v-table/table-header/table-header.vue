...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function getClassesForHeader(header) {
      const classes = [];
    ...
    function getTooltipForSortIcon(header) {
    ...
    function onResizeHandleMouseDown(header, event) {
    ...
    function onMouseMove(event) {
      if (dragging.value === true) {
        ...
        const newHeaders = currentHeaders.map((existing) => {
