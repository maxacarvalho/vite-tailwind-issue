<template>
  <private-view :title="bookmark ? bookmarkTitle : currentCollection.name">
    ...
    <component v-else :is="`layout-${layout || 'tabular'}`" class="layout">
      <template #no-results>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    function useBookmarks() {
      ...
      async function createBookmark(name) {
      ...
      async function editBookmark(name) {
